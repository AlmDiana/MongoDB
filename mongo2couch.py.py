...
URL = 'http://AlmDiana:d17121998k@localhost:5984'
print(URL)
...
CLIENT = MongoClient("mongodb+srv://arcadia:arcadia@cluster0.cmeb8.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
...
try:
    dbc = server.create('ejercicio_mongo')
except:
    dbc = server['ejercicio_mongo']
